...
```
From The accuracies are Training: 97.92%; Validation: 95.33%; and Test: 95.8%. From this comparision we can understand that the accuracy of Training is more than Test and Validation. Hence  we have best training model
